...
test('Темна тема: жодне поле вводу не лишається світлим', async ({ page }) => {
  // Сім маршрутів в одному тесті, і за кожним — своя сцена світу під
  // програмним рендерером. Це не повільна вада, це повільна робота: власний
  // бюджет замість того, щоб роздувати спільний для всіх.
  test.slow();
