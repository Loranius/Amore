    ...
    children: [
      {
        ...
        children: [{
          ...
          // `?view=calendar` — щоб той, хто прийшов по календар, побачив
          // календар: у модулі він тепер за тихим лічильником (ADR-0207).
          { path: 'calendar', element: <Navigate to="/plans?view=calendar" replace /> },
