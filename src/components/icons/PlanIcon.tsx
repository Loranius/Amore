 ...
 * Лампочка — «Ідея».
 *
 * Спершу тут стояв місяць із зіркою. На 14px у чипі статусу півмісяць
 * читався незамкненим колом, тобто круговою стрілкою «оновити» —
 * рендер показав це одразу на сторінці плану. Той місяць прибрано
 * зовсім: після заміни його не малювало вже ніщо.
 */
