...
// падав окремий модуль «Наша карта», щойно геокодер лишався без токена.
// Модуля вже немає (карта переїхала у «Спогади», ADR-0039), а межа
// лишилась: сторонній сервіс може відмовити будь-якому розділу.
//
