...
export function SweepPhotos({ years, asOf, isSaving, onImport }: SweepPhotosProps) {
  ...
  return (
    <section className="sweep-step">
      ...
      {/*
        * ДРУГИЙ ШЛЯХ НАЗВАНИЙ ТУТ, А НЕ ЛИШЕ ТАМ, ДЕ ВІН ЖИВЕ (ADR-0110).
        *
        * Власник: «дати лінивим людям вибір або додавати самі світлини, або
        * вказати приблизну кількість». Пара, яка не має файлів під рукою,
        * дивиться саме на цю картку — і мусить побачити, що вибір є, перш
        * ніж закриє екран. Саме поле стоїть у панелі року: число належить
        * рокові, а ця картка одна на всі роки.
        */}
      <p className="sweep-hint">
        Не маєте файлів під рукою? Тоді просто скажіть, скільки памʼятних
        знімків було в кожному році — поле стоїть у самій панелі року, під
        питаннями.
      </p>
