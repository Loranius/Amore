...
//  2. **місця, де пара вже була** — мітки «Нашої карти». Найчастіший
//     випадок: тераса, парк, дача повторюються десятками разів;
//  3. **пошук** — Mapbox, коли місця ще немає на карті.
//
...
// окремий модуль, і дублювати його всередині нотатника не варто.
// ============================================================
import { useEffect, useRef, useState } from 'react';
import { geocodePlaces } from '@/lib/mapbox';
...
export function PlaceSheet({ known, fromPhoto, onPick, onClear, onClose }: PlaceSheetProps) {
   ...
   * окреме звернення до Mapbox: «Хмельницький» коштував би дванадцять
