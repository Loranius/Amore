...
// Без емодзі в кінці: значок віхи вже стоїть ліворуч від цього тексту
// (GoalMilestones), тож ✨ 🤍 🌿 були другою позначкою в одному рядку —
// і єдиною, яку малює операційна система, а не застосунок.
