...
//
// *Менеджер фото полароїда* прибраний на прохання власника й переїхав у
// «Спогади» (ADR-0181): `features/polaroid/`, вхід дією заголовка. Поки
// він був просто прибраний, разом із ним ішла єдина дорога в бакет
// `family_photos` — і грань «Фотографії» кристала переставала рости. Це
// було названо тут, а не сховано, і саме тому протрималось один день.
// ============================================================
