        ...
        >
          ...
          >
            <EvolutionCrystalObject
              ...
              life={pipeline.life}
              /*
               * Камінь під кристалом дає РУЇНА, а не рушій (ADR-0063).
               *
               * ADR-0061 повернув опубліковану жилу на екран, бо під
               * друзою не було нічого. Відтоді руїна сіла підлогою, і
               * тепер під кристалом є справжній кам'яний настил
               * завтовшки 0.1846 — товщий за все, що жила ховала.
               *
               * Власник назвав те, що лишилось від жили, прямо: «оцей
               * п'єдестал, зверху фіолетовий, а донизу білий… його треба
               * прибрати, він піднімає кристал вище». Це був її бік:
               * підтверджено діагностичним кадром — з вимкненою жилою
               * біла прослойка зникає, чорні уламки руїни лишаються.
               *
               * Меш нікуди не подівся: рушій публікує його як і раніше,
               * і будь-який інший споживач отримує гарантію ADR-0003
               * незмінною. Не малює його САМЕ ЦЯ сцена, і саме тому
               * `portalRuin.test.ts` міряє, що настил руїни накриває
               * кожну закопану основу.
               */
