  ...
  return (
    <>
      ...
      {/* Заповнювальне світло: без нього грані, повернуті вниз, ідуть у
          ...
          кореня, «земля» — камінь підлоги печери: саме його бачить під
          собою нижній обвід друзи.

          Стіни печери це світло не торкається взагалі — вони намальовані
          (`portalCave.ts`), а не освітлені. */}
      <hemisphereLight args={[palette.rootLight, palette.caveFloor, palette.hemisphere]} />
