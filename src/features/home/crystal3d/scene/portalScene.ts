...
export const PORTAL_PALETTES: Record<'light' | 'dark', PortalPalette> = {
  ...
  light: {
    ...
    oculusIntensity: 2.1,
    /*
     * 0.30 → 0.18, і межу знайшов піксель, а не око.
     *
     * Промінь малюється адитивно й ДВОСТОРОННЬО: глядач бачить крізь
     * ближню стінку конуса дальню, тож додається двічі. На нічній сцені
     * це рахується як стовп пилу; на денній стіні, яка вже світла, ті
     * самі 0.30 вибивали верхню половину кадру в чисті 255,255,255.
     *
     * Виміряно на сорока роках: без променя 161, при 0.30 — 255
     * (обрізано), при 0.18 — 238, при 0.12 — 213. Узято 0.18: промінь
     * найсвітліший у кадрі, але ще має куди світлішати.
     */
    shaftOpacity: 0.18,
