...
export interface PortalPalette {
   ...
   * небом 99 з 255 проти 26 у ближніх, тобто далина кричала вчетверо
   * гучніше за близину. Було навпаки — фіолет угорі, тепло внизу.
   *
...
export const PORTAL_PALETTES: Record<'light' | 'dark', PortalPalette> = {
  ...
  light: {
     ...
     * перестала існувати — різниця з тлом упала до 7 з 255 на 3% кадру.
     *
