 ...
 *
 * Піднято з 0.2/0.17/0.145: на живому порталі тіло виходило близько
 * шістдесяти пікселів заввишки, і фото всередині нього не читалось — а саме
 * читабельність власник назвав вимогою.
 */
