...
describe('небо порталу (ADR-0165)', () => {
  ...
  it('починає небо кольором туману, а не зеніту', () => {
     ...
     * іншого — і кадр це показав: розрив дальніх хмар із небом був 99 з
     * 255 проти 26 у ближніх, тобто далина кричала вчетверо гучніше за
     * близину.
     *
  ...
  it('лишає хмару прохолоднішою за небо, у якому вона стоїть', () => {
     ...
     * переїхала туди, де стоїть море хмар, тепла хмара '#fbe3cd' впала
     * до розриву 7 з 255 на 3% кадру — тобто зникла. У вечірньому небі
