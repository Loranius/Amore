...
describe('portal environment cost', () => {
  it('accounts for every object the environment draws', () => {
    // Острів малює рівно шість: сам острів разом з уламками, храм, брили в
    // небі, рослинність, море хмар і водоспади. Печера малювала п'ять,
    // руїна з колонадою — тринадцять.
    //
    ...
    expect(PORTAL_ENVIRONMENT_DRAW_CALLS).toBe(6);
  });
