...
// ------------------------------------------------------------
// Species-шар кристала (Volume I): універсальну історію веде Evolution
// Engine (evolution/), а ТУТ вона стає видоспецифічними подіями відкладення
// — ЩО і КОЛИ відкладається (ключі, дати, капи, seed-офсети — байт-в-байт
// ті самі, що в попередньому поколінні рушія); ДЕ — вирішує ймовірнісне
// поле в mineralDeposition.ts.
//
