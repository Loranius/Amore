  ...
  it('keeps the monarch the same body at every age and seed, whatever form she wears', () => {
    ...
    for (const couple of COUPLES) {
      for (const years of AGES) {
        ...
        /*
         * **Смуга рухалась чотири рази, і кожен раз з приводу.** §2 брифу
         * просив 1.80–2.10; 2026-08-10 власник, дивлячись на портал,
         * попросив удвічі тонший монарх — смуга стала 3.4–4.35. Далі
         * 3.85–4.80 (ADR-0118: зник розхил) і 4.5–5.6 (ADR-0119: обхват
         * підтягнули до еталона).
         *
         * 2026-09-07 власник, знову дивлячись на портал, назвав те, що
         * вийшло, «просто стовпом рожевого кольору, який стирчить із
         * землі», і обрав «кластер із нижчим монархом». Еталон став
         * кремезнішим (`PRISM_ASPECT` 3.2 → 2.2), і наш монарх пішов за
         * ним: 3.42–4.08 виміряних тут проти 2.51 в еталона — числа не
