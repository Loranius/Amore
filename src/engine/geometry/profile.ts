...
/**
 * Наскільки глибоко монарх стоїть у ґрунті, у частках своєї видимої довжини.
 *
 * Було 0.10: рівно стільки, щоб шов закрився над основою й лінія
 * зустрічі була кварцом, а не чистим колом каменю.
 *
 * **0.10 → 0.18 → 0.15,** і остання цифра — вже не про вигляд, а про
 * покриття. Власник просив опустити кристал, бо «пласка платформа
 * виглядає вичурно»; 0.18 не пройшло смуги силуету, лишилось 0.16.
 * Відтоді портал перестав малювати жилу (ADR-0063), і закопані основи
 * ховає кам'яний настил руїни завтовшки **0.1846** сцени. При 0.16
 * найглибша базова кришка сягала **0.1898** — тобто виходила на 0.0052
 * нижче за низ настилу. Знизу цього не видно ніколи, але обіцянка, яку
 * не можна перевірити, не обіцянка.
 *
 * При 0.15 кришка на 0.1777, запас 0.0069, і `portalRuin.test.ts` це
 * міряє. Ціна — один відсоток видимої висоти кристала.
 */
const MONARCH_GROUND_SINK = 0.15;
