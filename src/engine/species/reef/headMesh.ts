 ...
 *
 * Латка — дві грані по колу на одне кільце по висоті. Тобто на куполі
 * їх дванадцять на вісім, і межі латок падають рівно на ребра, ніколи
 * не перетинаючи грань. Це той самий закон, що й у кристала: візерунок,
 * який перетинає ребро, каже оку, що дві площини — одна поверхня.
 */
const PATCH_SEGMENTS = 1;
