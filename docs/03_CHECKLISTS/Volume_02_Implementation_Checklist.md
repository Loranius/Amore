...
- [ ] Applicable `V2-REQ-*` IDs were copied into the task plan.
- [ ] Existing code and tests were audited before edits.
- [ ] Public package boundary and forbidden imports were confirmed.

## Required Capability

- [ ] species definition registry
- [ ] DNA runtime schemas and migrations
- [ ] trait resolution
- [ ] logical morphology
- [ ] adaptation
...
- [ ] `SpeciesProfile` has a runtime schema.
- [ ] `SpeciesProfile` is readonly after publication.
...
- [ ] All `V2-REQ-*` records are `VERIFIED`.
