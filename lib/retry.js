...
export const Retry = { run, query, isRetryable };

// Раніше тут публікувалась глобаль через window.Retry (архітектура без
// модулів). Тепер Retry імпортується явно як ES-модуль.
