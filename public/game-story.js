...
/* ============================================================
   ...
   - stage 1 (Садочок): обидва візити тепер відкривають кімнату
     садочку enterSadokRoom() (game-school.js) — 8 дітей на 4
     станціях, 2 з 4 обирає сам гравець — замість простого
     "зайди в будівлю x2";
...
async function storyOnZone(z){
  ...
  // 1. Садочок ×2 — кімната з 8 дітьми на 4 станціях (game-school.js)
  if(s===1){
