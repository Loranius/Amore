...
БУЛО 3.2, І ЦЕ ЗМІНЕНО НА ВКАЗІВКУ ВЛАСНИКА (2026-09-07), який дивився на
портал: «мені не подобається, як він виглядає — просто стовп рожевого
кольору, який стирчить із землі». Еталон 3.2 був чесним кварцом, і
генератор до нього зійшовся (відстань профілів 0.036) — тобто стовп був
не вадою виконання, а вірним відтворенням еталона, який більше не описує
те, чого хоче власник.

Кварц у друзі дає 2.5–5, і 2.2 — трохи нижче за цю смугу. Це свідомо:
власник обрав «нижчий монарх у кластері», а мінералогічну чесність тут
несе не стрункість, а КУТ ГОЛОВКИ, який лишається решітковим (52°).

Наслідок, який не треба окремо налаштовувати: головка росте сама.
Її висота — `радіус · tan52°`, тож при 2.2 вона займає 0.225 висоти
проти 0.167 при 3.2. «Велика корона» — це те, чим коротший кристал при
